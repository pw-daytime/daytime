    ...
    <form>
        <div class="form-row">
            <div class="form-group col-md-5">
                <input name="codProd" id="codProd" type="text" readonly class="form-control" placeholder="Cod. Prod.">
            </div>
            <div class="form-group col-md-4">
                <input name="nome" id="nome" type="text" class="form-control" placeholder="Produto">
            </div>
            <div class="form-group col-md-3">
                <input name="quantidade" id="quantidade" type="text" class="form-control" placeholder="Quantidade">
            </div>
